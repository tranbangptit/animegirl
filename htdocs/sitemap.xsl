			...
			<body>
				...
				<div id="intro">
					<p>
						...
						Generated by Phim Lẻ[TV] - admin@phimle.tv - <a href="http://www.phimle.tv/" target="_blank">Phim Lẻ[TV]</a>.<br/>
				...
				<div id="footer">
					Phim Lẻ[TV] sitemap - admin@phimle.tv - <a href="http://www.phimle.tv/" target="_blank">www.phimle.tv</a>
				</div>
			</body>
		</html>
	</xsl:template>
